...
/**
 * A basic, immutable, two dimensional representation of a kinematic data
 * structure.
 * 
 * <p>
...
public final class Kinematic {
	 ...
	 *             if position or velocity is null
	 */
	public Kinematic(Vector position, Vector velocity, float angle, float angularVelocity) {
	...
	public String toString() {
		return new StringBuilder().append("{:position ").append(position).append(" :velocity ").append(velocity)
				.append(" :angle ").append(angle).append(" :angularVelocity ").append(angularVelocity).append("}")
				.toString();
	}
