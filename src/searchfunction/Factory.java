...
public final class Factory {
	 ...
	 */
	public static <S> Heuristic<S> constant(float guess) {
		if (guess < 0) {
	 ...
	 */
	public static <S> Heuristic<S> zero() {
		return constant(0);
	}
	 ...
	 */
	public static <S> Heuristic<S> infinity() {
	 ...
	 *             if goal is null
	 */
	public static Heuristic<Vector> manhattan(Vector goal) {
		requireNonNull(goal);
	 ...
	 *             if goal is null
	 */
	public static Heuristic<Vector> euclidean(Vector goal) {
		requireNonNull(goal);
